...
class GenericDataFormatter(abc.ABC):
  ...
  def get_column_definition(self, use_data_only=False):
    """"Returns formatted column definition in order expected by the Model."""
  ...
  def _get_indices_from_spec(self):
  ...
  def get_experiment_params(self):
    ...
    required_keys = [
        'total_time_steps', 'num_epochs', 'multiprocessing_workers',
      'input_size', 'output_size', 'input_obs_loc', 'known_regular_inputs'

    ]

    fixed_params = self.get_fixed_params()
    fixed_params.update(self._get_indices_from_spec())
